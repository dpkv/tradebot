...
.PHONY: docker-build-tradebot-sandbox
docker-build-tradebot-sandbox: docker-build-tradebot
	$(DOCKER) tag $(IMAGE_TRADEBOT):$(TRADEBOT_IMAGE_TAG) $(IMAGE_TRADEBOT):$(TRADEBOT_IMAGE_TAG)-sandbox
